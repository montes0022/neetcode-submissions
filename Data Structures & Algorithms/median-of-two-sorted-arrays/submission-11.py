class Solution:
    def findMedianSortedArrays(self, nums1: List[int], nums2: List[int]) -> float:
        ...
        while True:
            ...
            #the only other condition so just put it in else.
            #video explanation had the elif Aright < Bleft: down in else and the ->
            #else here in the elif (elif Bright < Aleft)
            else:
                r = m -1
